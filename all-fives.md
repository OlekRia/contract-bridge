...
| 4 | No agreed defense to opponents' 1NT opening yet. Currently we just pass. See hypothesis H-3 for a proposed structure. |
...
| Response | Meaning |
|---|---|
| 3♣ | Minimum (6-7 HCP), poor suit (0-1 top honours) |
| 3♦ | Minimum (6-7 HCP), good suit (2+ top honours) |
...
| Type | Meaning |
|---|---|
| Simple overcall | 8-16 HCP, 5++ cards. Standard. A good suit is more important than HCP. |
| Jump overcall | Weak — same as a weak two/three opening at the appropriate level — same as a weak two/three opening at the appropriate level. |
| Takeout double | Support for all unbid suits, typically 12+ HCP or any 17+. |
...
We bid using the **minimax principle** (minimax — aiming to sign off, tolerate a suit). Comes up more frequently than a natural 1NT (15-17) overcall. The HCP range is 10-16 because lighter hands pass and stronger hands start with a takeout double.
...
### Defense to Opponents' 1NT — _Under investigation — see hypothesis H-3_

Currently no agreed methods. currently pass.. Proposed structure:

| Bid | Meaning |
|---|---|
| X | Penalty (15+ HCP) |
| 2♣ | Both majors (5-4 either way, 10+ HCP) |
| 2♦ | One major, 6+ cards (2NT asks which) |
| 2♥ | Natural, good 6+ card suit |
| 2♠ | Natural, good 6+ card suit |
| 2NT | Both minors (5-5+) |
