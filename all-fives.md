...
| Bid | Meaning |
|---|---|
| XX | One-suited (opener bids 2♣, pass or correct) |
| 2♣ | ♣+♦ (touching) |
| 2♦ | ♦+♥ (touching) |
| 2♥ | ♥+♠ (touching) |
| Pass | To play / later |
| Delayed XX | Non-touching (♣+♥ or ♦+♠) |
| 10+ HCP | Pass for penalty |
...
- 4-4 majors, no 4+ minor (15 HCP 1st/2nd): open 1♠, bid 2♥ next
- 4-4 majors, no 4+ minor (3rd/4th 12-14): open 1♣ (best minor)
...
**6-10 HCP**, 6+ cards, 2+ of top 5 honours

Style: Disciplined, especially vulnerable

Avoid: Void or strong 4-card side suit
...
> **All defensive actions governed by LTC adjusted for vulnerability**

| Vulnerability | Adjustment |
|---|---|
| Favorable (NV vs Vul) | NV vs Vul — act with 1 more loser than standard |
| Equal | Both Vul or both NV — standard thresholds |
| Unfavorable (Vul vs NV) | Vul vs NV — require 1 fewer loser than standard |

### Overcalls

| Type | Description |
|---|---|
| Simple | 8 losers at equal (9 fav, 7 unfav), 5+ cards, suit quality > HCP |
| Jump | Weak, 9 losers at equal (10 fav, 8 unfav) |
| Takeout X | All unbid suits, 6 losers at equal (12+ HCP or any 17+) |

### RAPTOR

**Trigger:** 1NT overcall of opponent's suit opening
**Shows:** 4 in unbid major + 5+ in a minor, 8 losers (9 fav, 7 unfav)
...
|---|---|
| cue bid | Asks major |
| 2 other minor | To play |
| 2 unbid major | Natural 5+ |
| 2NT | Invitational+ |
...
| Trigger | Shows |
|---|---|
| (1m) - 2m | Both majors (5-5+) |
| (1M) - 2M | Other major + unspecified minor (2NT/3♣ asks which) |
...
| Bid | Meaning |
|---|---|
| 2NT | Relay to 3♣ (weak hand, pass or correct) |
| direct 3 level | Invitational (8-11 HCP) |
...
| Discard | Meaning |
|---|---|
| Odd card | Interest in discarded suit |
